...
namespace YunfuTools
{
    ...
    /// <summary>
    /// XMLHelper XML字符串操作管理器
    /// </summary>
    public static class XMLStrHelper
    {

        #region XML字符串节点查询和读取
        /// <summary>
        ...
        public static XmlNode GetXmlNodeByXpath(string xml, string xpath)
        {
        ...
        public static XmlNodeList GetXmlNodeListByXpath(string xml, string xpath)
        {
            XmlDocument xmlDoc = new XmlDocument();
        ...
        public static XmlAttribute GetXmlAttribute(string xml, string xpath, string xmlAttributeName)
        {
